...
, org_apache_maven_mercury__mercury-logging__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-logging";
  coordinates = "org.apache.maven.mercury:mercury-logging:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-logging/1.0.0-alpha-2/mercury-logging-1.0.0-alpha-2.jar";
      sha256 = "0188c25f2ab0b616285bfc77997ad7f1a93498ccd7e5161832d85aa7e64c7e9f";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-logging__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
