...
, org_apache_maven_mercury__mercury-event__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-event";
  coordinates = "org.apache.maven.mercury:mercury-event:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-event/1.0.0-alpha-2/mercury-event-1.0.0-alpha-2.jar";
      sha256 = "d1197dfa0ee880b5a2ebde818c3cb3fb2019adc387a4a55c46ea9f220b918127";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-event__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
