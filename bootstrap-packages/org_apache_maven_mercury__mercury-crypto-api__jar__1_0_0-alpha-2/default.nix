...
patchMavenJar {
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-crypto-api/1.0.0-alpha-2/mercury-crypto-api-1.0.0-alpha-2.jar";
      sha256 = "c57a4a844cc7ace0108beb54a5b9a6f915719671cf76cf5e4b18604721051def";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-crypto-api__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
