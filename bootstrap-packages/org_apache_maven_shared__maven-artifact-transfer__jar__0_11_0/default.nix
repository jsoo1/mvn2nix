...
, org_apache_maven_shared__maven-common-artifact-filters__jar__3_0_1
...
, org_slf4j__slf4j-api__jar__1_7_5
, org_apache_maven_shared__maven-artifact-transfer__pom__0_11_0
}:
patchMavenJar {
  name = "maven-artifact-transfer";
  coordinates = "org.apache.maven.shared:maven-artifact-transfer:jar:0.11.0";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven_shared__maven-common-artifact-filters__jar__3_0_1;
      scope = "compile";
      optional = false;
    }
    {
    ...
    {
      drv = org_slf4j__slf4j-api__jar__1_7_5;
      scope = "compile";
      optional = false;
    }
    {
      drv = org_apache_maven_shared__maven-artifact-transfer__pom__0_11_0;
      scope = "test";
      optional = false;
    }
  ];
