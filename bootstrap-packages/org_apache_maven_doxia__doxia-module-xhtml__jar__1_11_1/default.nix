...
, org_apache_maven_doxia__doxia-module-xhtml__pom__1_11_1
}:
patchMavenJar {
  name = "doxia-module-xhtml";
  coordinates = "org.apache.maven.doxia:doxia-module-xhtml:jar:1.11.1";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/doxia/doxia-module-xhtml/1.11.1/doxia-module-xhtml-1.11.1.jar";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven_doxia__doxia-module-xhtml__pom__1_11_1;
      scope = "test";
      optional = false;
    }
  ];
