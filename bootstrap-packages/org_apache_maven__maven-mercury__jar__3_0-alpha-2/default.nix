...
, org_apache_maven__maven-mercury__pom__3_0-alpha-2
}:
patchMavenJar {
  name = "maven-mercury";
  coordinates = "org.apache.maven:maven-mercury:jar:3.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/maven-mercury/3.0-alpha-2/maven-mercury-3.0-alpha-2.jar";
      sha256 = "d956e6b318c42f54e72409030ebd4cd7a050020ddd1f96549329ddb402b86537";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven__maven-mercury__pom__3_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
