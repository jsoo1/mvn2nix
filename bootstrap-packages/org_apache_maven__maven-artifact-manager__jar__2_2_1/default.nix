...
, org_apache_maven__maven-artifact-manager__pom__2_2_1
}:
patchMavenJar {
  name = "maven-artifact-manager";
  coordinates = "org.apache.maven:maven-artifact-manager:jar:2.2.1";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven__maven-artifact-manager__pom__2_2_1;
      scope = "test";
      optional = false;
    }
  ];
