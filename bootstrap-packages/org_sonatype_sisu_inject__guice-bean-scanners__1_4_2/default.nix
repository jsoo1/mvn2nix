...
patchMavenJar {
  name = "org.sonatype.sisu.inject:guice-bean-scanners:1.4.2";
  groupId = "org.sonatype.sisu.inject";
  artifactId = "guice-bean-scanners";
  version = "1.4.2";
  classifier = null;
  artifacts = [
    {
      extension = "jar";
      drv = pkgs.fetchurl {
        url = "https://repo.maven.apache.org/maven2/org/sonatype/sisu/inject/guice-bean-scanners/1.4.2/guice-bean-scanners-1.4.2.jar";
        sha256 = "5e43b041b316000a5970683c3c6167cd8d670506003345e23ed92e559c9e5565";
      };
    }
    {
      extension = "pom";
      drv = pkgs.fetchurl {
        url = "https://repo.maven.apache.org/maven2/org/sonatype/sisu/inject/guice-bean-scanners/1.4.2/guice-bean-scanners-1.4.2.pom";
        sha256 = "7ebd8181977d22b966ae007de46915961a77b08f1e57fcd11328fc4c83a30869";
      };
    }
  ];
  dependencies = [
