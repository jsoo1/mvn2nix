...
patchMavenJar {
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-transport-api/1.0.0-alpha-2/mercury-transport-api-1.0.0-alpha-2.jar";
      sha256 = "4f2196c59b8976225000f0d079ad731a85cf8183d5ed6093dd1106a58518d252";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-transport-api__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
