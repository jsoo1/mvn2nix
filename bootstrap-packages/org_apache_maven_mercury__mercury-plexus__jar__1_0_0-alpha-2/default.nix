...
, org_apache_maven_mercury__mercury-plexus__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-plexus";
  coordinates = "org.apache.maven.mercury:mercury-plexus:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-plexus/1.0.0-alpha-2/mercury-plexus-1.0.0-alpha-2.jar";
      sha256 = "80800aad0155800f4d1b6e7512cd9a7ee7282c40db7e22abab8f8923e43539e7";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-plexus__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
