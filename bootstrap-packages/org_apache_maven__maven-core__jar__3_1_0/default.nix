...
, org_apache_maven__maven-core__pom__3_1_0
}:
patchMavenJar {
  name = "maven-core";
  coordinates = "org.apache.maven:maven-core:jar:3.1.0";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/maven-core/3.1.0/maven-core-3.1.0.jar";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven__maven-core__pom__3_1_0;
      scope = "test";
      optional = false;
    }
  ];
