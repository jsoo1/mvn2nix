...
, org_apache_maven__maven-compat__pom__3_0-alpha-2
}:
patchMavenJar {
  name = "maven-compat";
  coordinates = "org.apache.maven:maven-compat:jar:3.0-alpha-2";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven__maven-compat__pom__3_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
