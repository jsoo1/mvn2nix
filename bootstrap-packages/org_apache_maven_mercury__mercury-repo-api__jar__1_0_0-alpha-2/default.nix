...
, org_apache_maven_mercury__mercury-repo-api__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-repo-api";
  coordinates = "org.apache.maven.mercury:mercury-repo-api:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-repo-api/1.0.0-alpha-2/mercury-repo-api-1.0.0-alpha-2.jar";
      sha256 = "0ff5c68dcfa514523426e7c3cd42f0c8fdf4ce4a8c8d4d531f942e48ac0e6f94";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-repo-api__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
