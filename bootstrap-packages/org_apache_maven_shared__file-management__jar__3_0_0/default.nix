...
, org_apache_maven_shared__file-management__pom__3_0_0
}:
patchMavenJar {
  name = "file-management";
  coordinates = "org.apache.maven.shared:file-management:jar:3.0.0";
  ...
  dependencies = [
    ...
    {
      drv = org_apache_maven_shared__file-management__pom__3_0_0;
      scope = "test";
      optional = false;
    }
  ];
