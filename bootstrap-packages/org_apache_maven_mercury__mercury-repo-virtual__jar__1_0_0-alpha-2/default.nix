...
, org_apache_maven_mercury__mercury-repo-virtual__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-repo-virtual";
  coordinates = "org.apache.maven.mercury:mercury-repo-virtual:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-repo-virtual/1.0.0-alpha-2/mercury-repo-virtual-1.0.0-alpha-2.jar";
      sha256 = "ee6e66fd2361e81b9c79c33212b82deecf0f0689f12c7cdd4d29fa15f468d87e";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-repo-virtual__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
