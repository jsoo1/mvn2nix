...
, pkgs
, patchMavenJar
, org_apache_maven_surefire__maven-surefire-common__jar__3_0_0-M5
...
, org_apache_maven_plugins__maven-surefire-plugin__pom__3_0_0-M5
}:
patchMavenJar {
  name = "maven-surefire-plugin";
  coordinates = "org.apache.maven.plugins:maven-surefire-plugin:jar:3.0.0-M5";
  ...
  dependencies = [
    {
      drv = org_apache_maven_surefire__maven-surefire-common__jar__3_0_0-M5;
      scope = "compile";
      optional = false;
    }
    {
    ...
    {
      drv = org_apache_maven_plugins__maven-surefire-plugin__pom__3_0_0-M5;
      scope = "test";
      optional = false;
    }
  ];
