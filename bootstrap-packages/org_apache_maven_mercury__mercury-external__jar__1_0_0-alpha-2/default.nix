...
patchMavenJar {
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-external/1.0.0-alpha-2/mercury-external-1.0.0-alpha-2.jar";
      sha256 = "356b57e910ae5b80a469d00b7ce2188356db5dfb7701ca64e6fb4951b8c43afa";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-external__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
