...
, pkgs
, patchMavenJar
, org_apache_maven__maven-core__jar__3_0-alpha-2
...
, org_apache_maven__maven-toolchain__pom__3_0-alpha-2
}:
patchMavenJar {
  name = "maven-toolchain";
  coordinates = "org.apache.maven:maven-toolchain:jar:3.0-alpha-2";
  ...
  dependencies = [
    {
      drv = org_apache_maven__maven-core__jar__3_0-alpha-2;
      scope = "compile";
      optional = false;
    }
    {
    ...
    {
      drv = org_apache_maven__maven-toolchain__pom__3_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
