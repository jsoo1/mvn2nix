...
, pkgs
, patchMavenJar
, org_apache_maven_surefire__maven-surefire-common__jar__3_2_5
...
patchMavenJar {
  ...
  dependencies = [
    {
      drv = org_apache_maven_surefire__maven-surefire-common__jar__3_2_5;
      scope = "compile";
      optional = false;
    }
    {
    ...
    {
      drv = org_apache_maven_plugins__maven-surefire-plugin__pom__3_2_5;
      scope = "test";
      optional = false;
    }
  ];
