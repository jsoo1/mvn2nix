...
, org_apache_maven_mercury__mercury-crypto-basic__pom__1_0_0-alpha-2
}:
patchMavenJar {
  name = "mercury-crypto-basic";
  coordinates = "org.apache.maven.mercury:mercury-crypto-basic:jar:1.0.0-alpha-2";
  ...
  artifact = {
    extension = "jar";
    drv = pkgs.fetchurl {
      url = "https://repo.maven.apache.org/maven2/org/apache/maven/mercury/mercury-crypto-basic/1.0.0-alpha-2/mercury-crypto-basic-1.0.0-alpha-2.jar";
      sha256 = "3eaa0013944356f8b95aa7b33d0a61eca7868887d87898ffcf4bbf1e0f5161a8";
    };
  };
  dependencies = [
    {
    ...
    {
      drv = org_apache_maven_mercury__mercury-crypto-basic__pom__1_0_0-alpha-2;
      scope = "test";
      optional = false;
    }
  ];
